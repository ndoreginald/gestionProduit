...
namespace Atelier2.Controllers
{
    public class ProductController : Controller
    {
        ...
        public ActionResult Search(string term)
        {
            ...
            {
                return View("Index", ProductRepository.GetAll()); // Si la recherche est vide, retourne tous les produits
            }

            var result = ProductRepository.GetAll()
                                    .Where(p => p.Designation.Contains(term, StringComparison.OrdinalIgnoreCase));
